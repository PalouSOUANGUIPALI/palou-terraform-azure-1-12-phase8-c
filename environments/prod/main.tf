...
# Environnement : prod
# Fichier : main.tf
# Description : Assemblage des modules pour l'environnement prod.
#               Différences vs dev/staging :
#                 Service Bus SKU Premium — isolation réseau native
#                 Event Hub 4 TU          — capacité accrue pour la prod
#                 VM Flask D4s_v6         — 4 vCPU, 16 Go RAM
#                 purge_protection = true — protection contre la suppression accidentelle
# Auteur : Palou
# Date : Mars 2026
# ==============================================================================
...
module "compute" {
  ...
  # cidrhost("10.2.4.0/24", 4) = "10.2.4.4" — prévisible sans dépendre
