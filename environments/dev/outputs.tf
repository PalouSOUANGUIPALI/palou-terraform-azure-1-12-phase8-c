...
# Environnement : dev
# Fichier : outputs.tf
# Description : Outputs de l'environnement dev — informations utiles pour
#               la validation et l'exploration de l'infrastructure déployée.
# Auteur : Palou
# Date : Mars 2026
# ==============================================================================

output "resource_group_name" {
  description = "Nom du resource group dev"
  value       = module.networking.resource_group_name
}

output "vnet_name" {
  description = "Nom du VNet dev"
...
output "vm_app_identity_principal_id" {
  description = "Principal ID de la Managed Identity de la VM Flask — utile pour vérifier les attributions RBAC"
