...
# Nettoyage du tunnel à la sortie du script
trap 'info "Fermeture du tunnel Bastion..."; kill "$TUNNEL_PID" 2>/dev/null || true' EXIT
...
echo ""
echo "  Pour accéder aux interfaces, ouvrir un tunnel Bastion depuis l'ordinateur :"
echo ""
echo "  VM Monitoring (port 2222) :"
...
echo "    --port 2222"
echo ""
echo "  Puis dans un autre terminal, tunnels SSH vers les services :"
